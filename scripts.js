...
// ============================================
const lectureIconFiles = ['1','4','3','8','7','2','5','6'];
...
const lectures = [
  {
    title: 'Главные ошибки в общении и способы их преодоления',
    teaser: 'Как научиться эффективно общаться, задавая правильные вопросы и получая нужные ответы',
    body: `<p>Лекция о том, как брать интервью в повседневной жизни, как получать от людей необходимую вам информацию. Человек, умеющий общаться, может решать огромное количество проблем. Он вообще — вооружённый человек. Почему же мы так плохо и неумело общаемся, и как помочь нам решить эту важнейшую жизненную проблему?</p>
    <p>Практические примеры и интерактив с аудиторией позволяют участникам сразу применять навыки в жизни и работе, превращая умение общаться в реальный инструмент успеха.</p>`,
    outcomes: [
  ...
  {
    title: 'Психофилософия: как оказывать первую психологическую помощь',
    teaser: 'Помогаем себе и другим справляться, беря ответственность за свою жизнь',
    body: `<p>Мы редко отдаём себе отчёт в том, что буквально все люди на земле являются психологическими консультантами: мы все даём советы детям, родителям, знакомым. И делаем это, исходя исключительно из личного опыта.</p>
    <p>Максимов придумал систему, которая помогает людям решать их психологические проблемы. Почему желание должно быть главным движителем человека по жизни? Почему человек сам отвечает за ту реальность, в которой живёт? Что такое «теория привычек», и почему изменить жизнь можно только, изменив свои привычки? Как обрести смысл в жизни?</p>`,
    outcomes: [
  ...
  },
  {
    ...
    teaser: 'Выстраиваем отношения с ребёнком, помогая ему найти себя в современном мире',
    body: `<p>Лекция посвящена самым актуальным вопросам воспитания и гармоничных отношений с детьми. Как оторвать ребёнка от компьютера? Как помочь ему обрести призвание? Как выстроить отношения со школой?</p>
    <p>Максимов рассказывает, как мотивировать ребёнка, поддержать его интересы, помочь найти призвание. Практические советы и авторская психофилософия позволяют родителям стать для ребёнка не только наставником, но и надёжным другом, создавая атмосферу доверия и взаимопонимания.</p>`,
    outcomes: [
